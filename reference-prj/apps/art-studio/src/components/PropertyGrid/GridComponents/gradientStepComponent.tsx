...
import type { GradientBlockColorStep } from "@babylonjs/core/Materials/Node/Blocks/gradientBlock";
import { ColorPickerLineComponent } from "client-tools-ui-components/lines/colorPickerComponent";
